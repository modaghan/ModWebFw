...
namespace ModWebFw
{
    public static class CultureHelper
    {
        ...
        public static void SetCulture(this Controller context, Languages lang)
        {
            // Validate input
            string culture = "";
            switch (lang)
            {
                case Languages.Turkish:
                    culture = CultureHelper.GetImplementedCulture("tr-TR");
                    break;
                case Languages.English:
                    culture = CultureHelper.GetImplementedCulture("en");
                    break;
                default:
                    break;
            }
            ...
            string cookieName = "_" + Credentials.Software.TitleEn.Replace(" ", "") + "_culture";
